...
<li><strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">通义千问</font></font></strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">: Qwen2 0.5B, 1.5B, 7B</font></font></li>
</ul>
...
<span class="pl-k">for</span> <span class="pl-k">await</span> <span class="pl-kos">(</span><span class="pl-k">const</span> <span class="pl-s1">chunk</span> <span class="pl-k">of</span> <span class="pl-s1">chunks</span><span class="pl-kos">)</span> <span class="pl-kos">{</span>
  ...
  <span class="pl-k">if</span> <span class="pl-kos">(</span><span class="pl-s1">chunk</span><span class="pl-kos">.</span><span class="pl-c1">usage</span><span class="pl-kos">)</span> <span class="pl-kos">{</span>
    <span class="pl-smi">console</span><span class="pl-kos">.</span><span class="pl-en">log</span><span class="pl-kos">(</span><span class="pl-s1">chunk</span><span class="pl-kos">.</span><span class="pl-c1">usage</span><span class="pl-kos">)</span><span class="pl-kos">;</span> <span class="pl-c">// only last chunk has usage</span>
  <span class="pl-kos">}</span>
<span class="pl-kos">}</span>
...
<span class="pl-k">let</span> <span class="pl-s1">handler</span>: <span class="pl-smi">ServiceWorkerMLCEngineHandler</span><span class="pl-kos">;</span>
...
<p dir="auto"><font style="vertical-align: inherit;"></font><a href="/mlc-ai/web-llm/blob/main/examples/service-worker"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">您可以在examples/service-worker</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">中找到有关如何在服务工作者中运行 WebLLM 的完整示例</font><font style="vertical-align: inherit;">。</font></font></p>
<div class="markdown-heading" dir="auto"><h3 tabindex="-1" class="heading-element" dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Chrome 扩展程序</font></font></h3><a id="user-content-chrome-extension" class="anchor" aria-label="永久链接：Chrome 扩展程序" href="#chrome-extension"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="m7.775 3.275 1.25-1.25a3.5 3.5 0 1 1 4.95 4.95l-2.5 2.5a3.5 3.5 0 0 1-4.95 0 .751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018 1.998 1.998 0 0 0 2.83 0l2.5-2.5a2.002 2.002 0 0 0-2.83-2.83l-1.25 1.25a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042Zm-4.69 9.64a1.998 1.998 0 0 0 2.83 0l1.25-1.25a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042l-1.25 1.25a3.5 3.5 0 1 1-4.95-4.95l2.5-2.5a3.5 3.5 0 0 1 4.95 0 .751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018 1.998 1.998 0 0 0-2.83 0l-2.5 2.5a1.998 1.998 0 0 0 0 2.83Z"></path></svg></a></div>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">您还可以在</font></font><a href="/mlc-ai/web-llm/blob/main/examples/chrome-extension"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">examples/chrome-extension</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">和</font></font><a href="/mlc-ai/web-llm/blob/main/examples/chrome-extension-webgpu-service-worker"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">examples/chrome-extension-webgpu-service-worker</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">中找到使用 WebLLM 构建 Chrome 扩展程序的示例。后者利用了服务工作者，因此扩展程序在后台是持久的。</font></font></p>
<div class="markdown-heading" dir="auto"><h2 tabindex="-1" class="heading-element" dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">完全兼容 OpenAI</font></font></h2><a id="user-content-full-openai-compatibility" class="anchor" aria-label="永久链接：完全兼容 OpenAI" href="#full-openai-compatibility"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="m7.775 3.275 1.25-1.25a3.5 3.5 0 1 1 4.95 4.95l-2.5 2.5a3.5 3.5 0 0 1-4.95 0 .751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018 1.998 1.998 0 0 0 2.83 0l2.5-2.5a2.002 2.002 0 0 0-2.83-2.83l-1.25 1.25a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042Zm-4.69 9.64a1.998 1.998 0 0 0 2.83 0l1.25-1.25a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042l-1.25 1.25a3.5 3.5 0 1 1-4.95-4.95l2.5-2.5a3.5 3.5 0 0 1 4.95 0 .751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018 1.998 1.998 0 0 0-2.83 0l-2.5 2.5a1.998 1.998 0 0 0 0 2.83Z"></path></svg></a></div>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">WebLLM 旨在与</font></font><a href="https://platform.openai.com/docs/api-reference/chat" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">OpenAI API</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">完全兼容。因此，除了构建一个简单的聊天机器人之外，您还可以使用 WebLLM 实现以下功能：</font></font></p>
<ul dir="auto">
<li><a href="/mlc-ai/web-llm/blob/main/examples/streaming"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">streaming</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">：以 AsyncGenerator 的形式实时返回块输出</font></font></li>
<li><a href="/mlc-ai/web-llm/blob/main/examples/json-mode"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">json-mode</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">：有效确保输出为 JSON 格式，</font><font style="vertical-align: inherit;">更多信息请参阅</font></font><a href="https://platform.openai.com/docs/guides/text-generation/chat-completions-api" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">OpenAI 参考。</font></font></a><font style="vertical-align: inherit;"></font></li>
<li><a href="/mlc-ai/web-llm/blob/main/examples/seed-to-reproduce"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">seed-to-reproduce</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">：使用播种来确保字段的输出可重复</font></font><code>seed</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">。</font></font></li>
<li><a href="/mlc-ai/web-llm/blob/main/examples/function-calling"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">函数调用</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">（WIP）：带字段的函数调用</font></font><code>tools</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">（</font></font><code>tool_choice</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">初步支持）。</font></font></li>
</ul>
<div class="markdown-heading" dir="auto"><h2 tabindex="-1" class="heading-element" dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">定制模型</font></font></h2><a id="user-content-custom-models" class="anchor" aria-label="永久链接：自定义模型" href="#custom-models"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="m7.775 3.275 1.25-1.25a3.5 3.5 0 1 1 4.95 4.95l-2.5 2.5a3.5 3.5 0 0 1-4.95 0 .751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018 1.998 1.998 0 0 0 2.83 0l2.5-2.5a2.002 2.002 0 0 0-2.83-2.83l-1.25 1.25a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042Zm-4.69 9.64a1.998 1.998 0 0 0 2.83 0l1.25-1.25a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042l-1.25 1.25a3.5 3.5 0 1 1-4.95-4.95l2.5-2.5a3.5 3.5 0 0 1 4.95 0 .751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018 1.998 1.998 0 0 0-2.83 0l-2.5 2.5a1.998 1.998 0 0 0 0 2.83Z"></path></svg></a></div>
<p dir="auto"><font style="vertical-align: inherit;"></font><a href="https://github.com/mlc-ai/mlc-llm"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">WebLLM 是MLC LLM</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">的配套项目</font><font style="vertical-align: inherit;">，它支持 MLC 格式的自定义模型。它重用模型工件并构建 MLC LLM 的流程。要使用 WebLLM 编译和使用您自己的模型，请查看
</font></font><a href="https://llm.mlc.ai/docs/deploy/webllm.html" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">MLC LLM 文档，</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
了解如何编译和部署新的模型权重和库到 WebLLM。</font></font></p>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">这里我们来回顾一下高层的想法。WebLLM 包中有两个元素可以实现新的模型和权重变体。</font></font></p>
<ul dir="auto">
<li><code>model</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">：包含模型工件（例如权重和元数据）的 URL。</font></font></li>
<li><code>model_lib</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">：包含用于加速模型计算的可执行文件的 Web 程序集库（即 wasm 文件）的 URL。</font></font></li>
</ul>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">两者均可在 WebLLM 中定制。</font></font></p>
<div class="highlight highlight-source-ts notranslate position-relative overflow-auto" dir="auto"><pre><span class="pl-k">import</span> <span class="pl-kos">{</span> <span class="pl-smi">CreateMLCEngine</span> <span class="pl-kos">}</span> <span class="pl-k">from</span> <span class="pl-s">"@mlc-ai/web-llm"</span><span class="pl-kos">;</span>

<span class="pl-k">async</span> <span class="pl-s1">main</span><span class="pl-kos">(</span><span class="pl-kos">)</span> <span class="pl-kos">{</span>
  <span class="pl-k">const</span> <span class="pl-s1">appConfig</span> <span class="pl-c1">=</span> <span class="pl-kos">{</span>
    <span class="pl-s">"model_list"</span>: <span class="pl-kos">[</span>
      <span class="pl-kos">{</span>
        <span class="pl-s">"model"</span>: <span class="pl-s">"/url/to/my/llama"</span><span class="pl-kos">,</span>
        <span class="pl-s">"model_id"</span>: <span class="pl-s">"MyLlama-3b-v1-q4f32_0"</span>
        <span class="pl-s">"model_lib"</span>: <span class="pl-s">"/url/to/myllama3b.wasm"</span><span class="pl-kos">,</span>
      <span class="pl-kos">}</span>
    <span class="pl-kos">]</span><span class="pl-kos">,</span>
  <span class="pl-kos">}</span><span class="pl-kos">;</span>
  <span class="pl-c">// override default</span>
  <span class="pl-k">const</span> <span class="pl-s1">chatOpts</span> <span class="pl-c1">=</span> <span class="pl-kos">{</span>
    <span class="pl-s">"repetition_penalty"</span>: <span class="pl-c1">1.01</span>
  <span class="pl-kos">}</span><span class="pl-kos">;</span>

  <span class="pl-c">// load a prebuilt model</span>
  <span class="pl-c">// with a chat option override and app config</span>
  <span class="pl-c">// under the hood, it will load the model from myLlamaUrl</span>
  <span class="pl-c">// and cache it in the browser cache</span>
  <span class="pl-c">// The chat will also load the model library from "/url/to/myllama3b.wasm",</span>
  <span class="pl-c">// assuming that it is compatible to the model in myLlamaUrl.</span>
  <span class="pl-k">const</span> <span class="pl-s1">engine</span> <span class="pl-c1">=</span> <span class="pl-k">await</span> <span class="pl-smi">CreateMLCEngine</span><span class="pl-kos">(</span>
    <span class="pl-s">"MyLlama-3b-v1-q4f32_0"</span><span class="pl-kos">,</span>
    <span class="pl-kos">{</span> appConfig <span class="pl-kos">}</span><span class="pl-kos">,</span> <span class="pl-c">// engineConfig</span>
    <span class="pl-s1">chatOpts</span><span class="pl-kos">,</span>
  <span class="pl-kos">)</span><span class="pl-kos">;</span>
<span class="pl-kos">}</span></pre><div class="zeroclipboard-container">
    <clipboard-copy aria-label="Copy" class="ClipboardButton btn btn-invisible js-clipboard-copy m-2 p-0 tooltipped-no-delay d-flex flex-justify-center flex-items-center" data-copy-feedback="Copied!" data-tooltip-direction="w" value="import { CreateMLCEngine } from &quot;@mlc-ai/web-llm&quot;;
...
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">在许多情况下，我们只想提供模型权重变体，而不一定是新模型（例如</font></font><code>NeuralHermes-Mistral</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">可以重用 的</font></font><code>Mistral</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">模型库）。有关不同模型变体如何共享模型库的示例，请参阅</font></font><code>webllm.prebuiltAppConfig</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">。</font></font></p>
<div class="markdown-heading" dir="auto"><h2 tabindex="-1" class="heading-element" dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">从源代码构建 WebLLM 包</font></font></h2><a id="user-content-build-webllm-package-from-source" class="anchor" aria-label="永久链接：从源代码构建 WebLLM 包" href="#build-webllm-package-from-source"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="m7.775 3.275 1.25-1.25a3.5 3.5 0 1 1 4.95 4.95l-2.5 2.5a3.5 3.5 0 0 1-4.95 0 .751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018 1.998 1.998 0 0 0 2.83 0l2.5-2.5a2.002 2.002 0 0 0-2.83-2.83l-1.25 1.25a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042Zm-4.69 9.64a1.998 1.998 0 0 0 2.83 0l1.25-1.25a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042l-1.25 1.25a3.5 3.5 0 1 1-4.95-4.95l2.5-2.5a3.5 3.5 0 0 1 4.95 0 .751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018 1.998 1.998 0 0 0-2.83 0l-2.5 2.5a1.998 1.998 0 0 0 0 2.83Z"></path></svg></a></div>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">注意：除非您想更改 WebLLM 包，否则无需自行构建。若要简单地使用 npm，请按照</font></font><a href="#get-started"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">入门指南</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">或任何</font></font><a href="/mlc-ai/web-llm/blob/main/examples"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">示例操作</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">。</font></font></p>
<p dir="auto"><font style="vertical-align: inherit;"></font><a href="https://github.com/mlc-ai/mlc-llm"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">WebLLM 包是专为MLC LLM</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">设计的 Web 运行时</font><font style="vertical-align: inherit;">。</font></font></p>
<ol dir="auto">
<li>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">安装编译所需的所有先决条件：</font></font></p>
<ol dir="auto">
<li><a href="https://emscripten.org" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">emscripten</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">。它是一个基于 LLVM 的编译器，可将 C/C++ 源代码编译为 WebAssembly。
</font></font><ul dir="auto">
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">按照</font></font><a href="https://emscripten.org/docs/getting_started/downloads.html#installation-instructions-using-the-emsdk-recommended" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">安装说明</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">安装最新的 emsdk。</font></font></li>
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">来源</font></font><code>emsdk_env.sh</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">为</font></font><code>source path/to/emsdk_env.sh</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">，以便</font></font><code>emcc</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">可以从 PATH 访问并且命令</font></font><code>emcc</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">有效。</font></font></li>
</ul>
</li>
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">按照</font></font><a href="https://jekyllrb.com/docs/installation/" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">官方指南</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">安装 jekyll 。这是我们用于网站的软件包。如果您使用 nextjs（请参阅示例中的 next-simple-chat），则不需要执行此操作。</font></font></li>
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">通过命令安装 jekyll-remote-theme。</font><font style="vertical-align: inherit;">如果安装不成功，
可以尝试</font></font><a href="https://gems.ruby-china.com/" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">gem mirror</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> 。我们可以分别在终端中</font></font><code>shell gem install jekyll-remote-theme </code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
尝试</font></font><code>emcc</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">和来验证是否安装成功。</font></font><code>jekyll</code><font style="vertical-align: inherit;"></font></li>
</ol>
</li>
<li>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">设置必要的环境</font></font></p>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">准备 Web 构建所需的所有依赖项：</font></font></p>
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto"><pre>./scripts/prep_deps.sh</pre><div class="zeroclipboard-container">
    <clipboard-copy aria-label="Copy" class="ClipboardButton btn btn-invisible js-clipboard-copy m-2 p-0 tooltipped-no-delay d-flex flex-justify-center flex-items-center" data-copy-feedback="Copied!" data-tooltip-direction="w" value="./scripts/prep_deps.sh" tabindex="0" role="button">
      <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-copy js-clipboard-copy-icon">
    <path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"></path><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"></path>
</svg>
      <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-check js-clipboard-check-icon color-fg-success d-none">
...
<li>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Buld WebLLM 包</font></font></p>
...
<li>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">验证一些子包</font></font></p>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">然后，您可以转到</font></font><a href="/mlc-ai/web-llm/blob/main/examples"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">示例</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">中的子文件夹来验证一些子包。我们使用 Parcelv2 进行捆绑。尽管 Parcel 有时不太擅长跟踪父目录的更改。当您在 WebLLM 包中进行更改时，请尝试编辑</font></font><code>package.json</code><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
子文件夹的并保存它，这将触发 Parcel 重建。</font></font></p>
</li>
</ol>
...
<ul dir="auto">
<li><a href="https://chat.webllm.ai/" rel="nofollow"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">演示应用程序：WebLLM 聊天</font></font></a></li>
<li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">如果您想在本机运行时运行 LLM，请查看</font></font><a href="https://github.com/mlc-ai/mlc-llm"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">MLC-LLM</font></font></a></li>
<li><font style="vertical-align: inherit;"></font><a href="https://github.com/mlc-ai/web-stable-diffusion/"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">您可能还对Web Stable Diffusion</font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">感兴趣</font><font style="vertical-align: inherit;">。</font></font></li>
</ul>
...
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">该项目由 CMU Catalyst、UW SAMPL、SJTU、OctoML 和 MLC 社区的成员发起。我们很乐意继续发展和支持开源 ML 社区。</font></font></p>
<p dir="auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">这个项目的成功离不开我们站在开源生态系统的肩膀上。我们要感谢 Apache TVM 社区和 TVM Unity 项目的开发人员。开源 ML 社区成员将这些模型公开。PyTorch 和 Hugging Face 社区使这些模型易于访问。我们要感谢 Vicuna、SentencePiece、LLaMA 和 Alpaca 背后的团队。我们还要感谢 WebAssembly、Emscripten 和 WebGPU 社区。最后，感谢 Dawn 和 WebGPU 开发人员。</font></font></p>
</article></div>
